...
<body>
        ...
        <div class="container"><a class="navbar-brand" href="home.php" style="font-family: Montserrat, sans-serif;">BookItUp!</a><button data-toggle="collapse" class="navbar-toggler" data-target="#navcol-1"><i class="fas fa-hamburger" style="color: white;"></i><span class="sr-only">Toggle navigation</span></button>
            <div class="collapse navbar-collapse" id="navcol-1">
                <form class="form-inline mr-auto" target="_self" method="POST">
                    <div class="form-group"><label for="search-field" style="width: 50px;"></label><input class="form-control search-field" type="search" id="search-field" name="searchEvents" placeholder="Search for locations" style="font-family: Montserrat, sans-serif;color: white;" autocomplete="on">
                    <button class="btn btn-outline-primary btn-sm search-btn" type="submit" style="border-radius: 50%;border: none;color:white; border-color:white;" name="search"><i class="fa fa-search"></i></div>
                </form>
                ...
                <ul class="nav navbar-nav">
                    <li class="nav-item" role="presentation"><a class="nav-link" href="cart.php" style="font-family: Montserrat, sans-serif;" id="cart">Cart</a></li>
                </ul>
                <form method="POST">
    ...
    <div class="container">
    <h2 style="margin-top:50px; font-weight:bold">Feedback</h2>
        <hr>
    </div>
    <div class="container text-center">
        <form method="POST" class="text-center">
                <div class="form-group">
                    <input type="text" name="fname" placeholder="Name" style="width:100%; padding:5px; font-size:20px; border-top:none; border-right:none; border-left:none;" class="shadow">
                </div>
                <div class="form-group">
                    <input type="email" name="fmail" placeholder="Email" style="width:100%;padding:5px; font-size:20px;border-top:none; border-right:none; border-left:none;" class="shadow">
                </div>
                <div class="form-group">
                    <textarea name="response" placeholder="Let us know what you think!" style="width:100%;padding:5px; font-size:20px; border-top:none; border-right:none; border-left:none;" class="shadow"></textarea>
                </div>
                <button class="btn btn-outline-secondary btn-block" type="submit" name="res_submit">Send</button>
        </form>
        <?php
            // if(isset($_POST['res_submit']))
            // {
            //     include("feedbackPHP.php");
            //     response($_POST['fname'],$_POST['fmail'],$_POST['response']);
            // }
        ?>
    </div>
