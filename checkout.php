...
<body>
    ...
    <div class="container">
    <div>
            <p style="font-family: Montserrat, sans-serif;font-size: 24px;"><strong>Checkout</strong></p>
            <hr>
            
        </div>
        <div>
                <table style="border:1px solid black; width:100%; font-size:20px;">
                        <th style="border:1px solid black">Event Name</th>
                        <th style="border:1px solid black">Price</th>
                    </tr>
                    <?php 
                    include("checkoutPHP.php");
                    checkout_cart($_SESSION['suname']);
                    ?>
                </table>

                <div style="margin-top:50px">
                <b>Pay using UPI:
                <div class="form-group" style="display:inline"><input class="form-control event-name" type="text" placeholder="UPI ID" style="border-top: none;border-left: none;border-right: none;width: 100%;" name='UPI'></div>
