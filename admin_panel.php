...
<body>
    ...
    <div>
        <div class="container">
            <div class="row">
                <div class="col-md-6 text-center"><a href="event_details.php" style="text-decoration: none;"><i class="typcn typcn-info-large-outline" style="font-size: 150px;"></i><p style="font-family: Montserrat, sans-serif;font-size: 24px;"><strong>Add new event</strong></p></a></div>
                <div
                    class="col-md-6 text-center"><a href="promo-details.php" style="text-decoration: none;"><i class="typcn typcn-news" style="font-size: 150px;"></i><p style="font-family: Montserrat, sans-serif;font-size: 24px;"><strong>Add new promotion</strong></p></a></div>
        </div>
    </div>
    <?php 
						if(isset($_POST['logout'])){
