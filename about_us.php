...
<body>
    ...
    <div class="container">
    <h2 style="margin-top:50px; font-weight:bold">About Us.</h2>
        <hr>
    </div>
    <div class="container text-center">
        <div style="padding-bottom: 20px">
                <img src="" style="height:200px;width:200px;border-radius:50%;">
                <p style="margin:20px; font-size:24px; font-weight:bold"> Name </p>
                <p style="margin:20px; font-size:16px;">Other Details</p>
        </div>
        <div style="padding-bottom: 20px">
                <img src="" style="height:200px;width:200px;border-radius:50%;">
                <p style="margin:20px; font-size:24px; font-weight:bold"> Name </p>
