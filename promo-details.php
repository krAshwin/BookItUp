...
<body>
    ...
    <div class="container">
    <?php include("promo_detailsPHP.php");?>
        <h3 style="font-family: Montserrat, sans-serif;"><strong>Add a new promotion</strong></h3>
        <hr>
        <div>
            <p style="font-family: Montserrat, sans-serif;"><strong>Note : Every Image must be 250px wide by 250px high.</strong></p>

            

            <form style="margin-left: 20px;" enctype="multipart/form-data" method="POST">
                <div class="form-group"><label style="font-family: Montserrat, sans-serif;"><strong>Promotion 1 Image File :&nbsp;</strong></label><input type="file" style="font-family: Montserrat, sans-serif;" accept=image/* name="promo1"></div>
                <div class="form-group"><label style="font-family: Montserrat, sans-serif;"><strong>Promotion 2 Image File :&nbsp;</strong></label><input type="file" style="font-family: Montserrat, sans-serif;" accept=image/* name="promo2"></div>
                <div class="form-group"><label style="font-family: Montserrat, sans-serif;"><strong>Promotion 3 Image File :&nbsp;</strong></label><input type="file" style="font-family: Montserrat, sans-serif;" accept=image/* name="promo3"></div>
                <div class="form-group"><label style="font-family: Montserrat, sans-serif;"><strong>Promotion 4 Image File :&nbsp;</strong></label><input type="file" style="font-family: Montserrat, sans-serif;" accept=image/* name="promo4"></div>
                <div class="d-block text-center" style="margin-top: 30px;"><button class="btn btn-outline-secondary" type="submit" style="font-family: Montserrat, sans-serif;font-weight: bold;width: 30%;">Add new promotions</button></div>
            </form>
            <?php 
						if(isset($_POST['logout'])){
							session_destroy();
