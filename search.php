...
<body>
    ...
    <div class="container">
        <p style="font-family: Montserrat, sans-serif;font-weight: normal;font-size: 24px;"><strong>Events on Searched Location: <?php echo $_GET['search_key'] ?></strong></p>
        <hr>
    </div>
    <div class="container">
        <div class="row">
