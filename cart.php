...
<body>
    ...
    <div class="container">
    <div>
            <p style="font-family: Montserrat, sans-serif;font-size: 24px;"><strong>Cart</strong></p>
            <hr>
    ...
    <?php 
        ...
        if(checkCartCheckout($_SESSION['suname'])){
            echo '<form method="POST"><div class="d-inline-block float-right"><button class="btn btn-primary" type="submit" name = "checkout" style="background-color: rgb(37,37,37);border-color: rgba(0,0,0,0);"><strong>Checkout</strong></button></div></form>';
